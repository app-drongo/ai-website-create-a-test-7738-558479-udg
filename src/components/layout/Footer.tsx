...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Live Training Sessions', href: '/webinars' },
  ...
  const socialLinks = [
    { name: 'Twitter', icon: Twitter, href: 'https://twitter.com/testwebsite' },
    { name: 'Facebook', icon: Facebook, href: 'https://facebook.com/testwebsite' },
    { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/testwebsite' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/testwebsite' },
    { name: 'GitHub', icon: Github, href: 'https://github.com/testwebsite' },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">TestWebsite</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering developers and businesses with cutting-edge web development tools and
                innovative design solutions. Join our growing community of creators building the
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">support@testwebsite.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Innovation Drive, Tech Hub 200</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive platform updates, feature releases, and developer insights. Unsubscribe
                anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 TestWebsite. All rights reserved.</span>
