...
export default function Hero() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Navigate to home for conversion
  };

  const handleSecondaryAction = () => {
    router.push('/features'); // Navigate to features page
  };

  const handleBadgeAction = () => {
    router.push('/features'); // Navigate to features for AI updates
  };
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              Revolutionary Cloud Infrastructure Now Live
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Enterprise-grade infrastructure meets startup agility. Deploy, scale, and innovate
              with our AI-powered platform trusted by the world's fastest-growing tech companies.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.8/5 from CTOs</span>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground font-medium">TestWebsite Dashboard</p>
